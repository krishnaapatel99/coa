...
int main() {
    ...
    int line_bits = log2(cache_lines);
    int tag_bits = address_bits - (byte_bits + line_bits);

    cout << "\n--- RESULTS ---\n";
    cout << "Size of Cache memory = " << cache_size_kb << " KB\n";
    cout << "Size of Main memory = " << main_size_mb << " MB\n";
    cout << "Main memory address = " << address_bits << " bits\n";
    cout << "Cache lines = " << cache_lines << "\n";
    cout << "Mapping Policy: Direct Mapping\n";
    cout << "Tag bits = " << tag_bits << ", Line bits = " << line_bits << ", Byte bits = " << byte_bits << "\n";

    int block_num;
    cout << "\nEnter any Main memory block number: ";
    cin >> block_num;

    int cache_line = block_num % cache_lines;
    cout << "Block " << block_num << " is mapped into cache line number = " << cache_line << endl;
